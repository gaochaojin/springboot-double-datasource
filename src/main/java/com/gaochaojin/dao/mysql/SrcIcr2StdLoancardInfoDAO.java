 ...
 */
@Repository
public interface SrcIcr2StdLoancardInfoDAO extends JpaRepository<SrcIcr2StdLoancardInfo, Integer> {

    List<SrcIcr2StdLoancardInfo> findBySrcIcId(Integer srcIcId);
